  ...
  return (
    <section className="py-20  md:py-24">
      <div className="container">
        ...
        <div className="overflow-hidden mt-10 [mask-image:linear-gradient(to_right,transparent,black_20%,black_80%,transparent)] flex">
          <motion.div
            initial={{
              translateX: "-50%",
            }}
          ...
          >
            {[...testimonials, ...testimonials].map((testimonial) => (
              <div
                ...
                className="border border-white/15 p-6 md:p-10 rounded-xl bg-[linear-gradient(to_bottom_left,rgb(148,69,255,.3),black)] max-w-xs md:max-w-md flex-none "
              >
